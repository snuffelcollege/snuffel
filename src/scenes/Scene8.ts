...
import BoyHugSheet from "@assets/spritesheets/scenario_8/boyhug.png";
import BoyHugData from "@assets/spritesheets/scenario_8/boyhug.json";
import BoyPetSheet from "@assets/spritesheets/scenario_8/boypet.png";
import BoyPetData from "@assets/spritesheets/scenario_8/boypet.json";
import BoyHandSheet from "@assets/spritesheets/scenario_8/boyhand.png";
import BoyHandData from "@assets/spritesheets/scenario_8/boyhand.json";
import VinceIdleSheet from "@assets/spritesheets/scenario_8/vinceidle.png";
import VinceIdleData from "@assets/spritesheets/scenario_8/vinceidle.json";
import DogIdleSheet from "@assets/spritesheets/scenario_8/dogidle.png";
import DogIdleData from "@assets/spritesheets/scenario_8/dogidle.json";
import DogSniffSheet from "@assets/spritesheets/scenario_8/dogsniff.png";
import DogSniffData from "@assets/spritesheets/scenario_8/dogsniff.json";
import DogPullSheet from "@assets/spritesheets/scenario_8/dogpull.png";
import DogPullData from "@assets/spritesheets/scenario_8/dogpull.json";
...
export default class Scene1 extends Scene implements SceneLifecycle {
	...
	public init(): void {
		...
		this.characterRun = "characterRun8";
		this.vinceIdle = "vinceIdle8";
		this.dogIdle = "dogIdle8";
		this.dogSniff = "dogSniff8";
		this.dogPull = "dogPull8";
		this.boyHand = "boyHand8";
		this.boyPet = "boyPet8";
		this.boyHug = "boyHug8";
	...
	public preload(): void {
		...
		this.load.audio("8option2audio", Option2Audio);
		this.load.audio("8option3audio", Option3Audio);
		this.load.aseprite(
			this.characterWalk,
			CharacterWalkSheet,
			CharacterWalkData
	...
	private createChoice(): void {
		...
		this.sound.add("8starttextaudio", {volume: 1}).play();
		...
		button1.on("pointerover", () => {
			this.game.sound.removeByKey("8starttextaudio");
			this.sound.add("8option1audio", {volume: 1}).play();
			button1.angle = 5;			
		});
		button1.on('pointerout',() => {
			this.game.sound.removeByKey("8option1audio");
			button1.angle = 0;
		})
		...
		button2.on("pointerover", () => {
			this.game.sound.removeByKey("8starttextaudio");
			this.sound.add("8option2audio", {volume: 1}).play();
			button2.angle = 5;			
		});
		button2.on('pointerout',() => {
			this.game.sound.removeByKey("8option2audio");
			button2.angle = 0;
		})
		...
		button3.on("pointerover", () => {
			this.game.sound.removeByKey("8starttextaudio");
			this.sound.add("8option3audio", {volume: 1}).play();
			button3.angle = 5;			
		});
		button3.on('pointerout',() => {
			this.game.sound.removeByKey("8option3audio");
			button3.angle = 0;
		})
	...
	private createResult2(): void {
		...
		movetoSpencer.movingDone = () => {
			...
			setTimeout(() => {
				...
				const badgeS2Image = this.add.sprite(736,481, "badge2").setScale(0.6).setVisible(WorldScene.scenario2Fininshed).setAlpha(0).setDepth(1);
				const badgeS3Image = this.add.sprite(966,481, "badge3").setScale(0.6).setVisible(WorldScene.scenario3Fininshed).setAlpha(0).setDepth(1);
				const badgeS4Image = this.add.sprite(1200,481, "badge4").setScale(0.6).setVisible(WorldScene.scenario4Fininshed).setAlpha(0).setDepth(1);
				const badgeS5Image = this.add.sprite(1430,481, "badge5").setScale(0.6).setVisible(WorldScene.scenario5Fininshed).setAlpha(0).setDepth(1);
				const badgeS6Image = this.add.sprite(512,690, "badge6").setScale(0.6).setVisible(WorldScene.scenario6Fininshed).setAlpha(0).setDepth(1);
